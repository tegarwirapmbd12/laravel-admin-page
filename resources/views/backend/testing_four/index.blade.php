                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header justify-content-between">
                                ...
                                <a href="{{ route('testing_fours.create') }}"
                            ...
                            <div class="card-body">
                                <form action="{{ route('testing_fours.index') }}" method="GET" class="row g-3">
<div class="col-md-6">
                                                    ...
                                                    <td class="text-end">
                                                        <div class="dropdown text-muted">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-end">
                                                                <a href="{{ route('testing_fours.show', $item->uuid) }}"
                                                                    class="dropdown-item">
                                                                    <i data-lucide="eye" class="me-1"></i>
                                                                    View
                                                                </a>
                                                                <a href="{{ route('testing_fours.edit', $item->uuid) }}"
                                                                    class="dropdown-item">
                                                        ...
                                                        <form id="delete-form-{{ $item->uuid }}"
                                                            action="{{ route('testing_fours.destroy', $item->uuid) }}"
