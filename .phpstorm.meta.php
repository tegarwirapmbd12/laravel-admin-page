...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'cache.prefix' => 'string',
            'crud_generator.generate_migration' => 'boolean',
            'crud_generator.generate_model' => 'boolean',
            'crud_generator.generate_repository' => 'boolean',
            'crud_generator.generate_controller' => 'boolean',
            'crud_generator.generate_routes' => 'boolean',
            'crud_generator.generate_blade' => 'boolean',
            'crud_generator.generate_sidenav' => 'boolean',
            'crud_generator.sidenav_default_icon' => 'string',
            'crud_generator.soft_deletes' => 'boolean',
            'crud_generator.api_controller' => 'boolean',
            'crud_generator.validation_rules.default' => 'string',
            'crud_generator.validation_rules.string' => 'string',
            'crud_generator.validation_rules.text' => 'string',
            'crud_generator.validation_rules.integer' => 'string',
            'crud_generator.validation_rules.boolean' => 'string',
            'crud_generator.validation_rules.date' => 'string',
            'crud_generator.validation_rules.dateTime' => 'string',
            'crud_generator.validation_rules.timestamp' => 'string',
            'crud_generator.validation_rules.email' => 'string',
            ...
            'filesystems.links.C:\laragon\www\laravel-admin-page\public\storage' => 'string',
...
'cache.stores.octane.driver','cache.stores.failover.driver','cache.stores.failover.stores','cache.prefix','crud_generator.generate_migration',
'crud_generator.generate_model','crud_generator.generate_repository','crud_generator.generate_controller','crud_generator.generate_routes','crud_generator.generate_blade',
'crud_generator.generate_sidenav','crud_generator.sidenav_default_icon','crud_generator.soft_deletes','crud_generator.api_controller','crud_generator.validation_rules.default',
'crud_generator.validation_rules.string','crud_generator.validation_rules.text','crud_generator.validation_rules.integer','crud_generator.validation_rules.boolean','crud_generator.validation_rules.date',
'crud_generator.validation_rules.dateTime','crud_generator.validation_rules.timestamp','crud_generator.validation_rules.email','database.default','database.connections.sqlite.driver',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\laragon\\www\\laravel-admin-page\\public\\storage','logging.default',
...
'signed','throttle','verified',);
        registerArgumentsSet('routes', 'crud.index','crud.generate','example_cruds.index',
'example_cruds.create','example_cruds.store','example_cruds.show','example_cruds.edit','example_cruds.update',
'example_cruds.destroy','testing_twos.index','testing_twos.create','testing_twos.store','testing_twos.show',
'testing_twos.edit','testing_twos.update','testing_twos.destroy','storage.local','storage.local.upload',);
        registerArgumentsSet('views', 
'auth-split.delete-account','auth-split.lock-screen','auth-split.login-pin','auth-split.new-pass','auth-split.reset-pass',
'auth-split.sign-in','auth-split.sign-up','auth-split.success-mail','auth-split.two-factor','auth.delete-account',
'auth.lock-screen','auth.login-pin','auth.new-pass','auth.reset-pass','auth.sign-in',
'auth.sign-up','auth.success-mail','auth.two-factor','crud-generator.index','error.400',
'error.401','error.403','error.404','error.408','error.500',
'error.maintenance','example_crud.create','example_crud.edit','example_crud.index','example_crud.show',
'icons.lucide','index','layouts.app','layouts.boxed','layouts.compact',
'layouts.horizontal','layouts.preloader','layouts.scrollable','layouts.sidebar.compact','layouts.sidebar.dark',
'layouts.sidebar.gradient','layouts.sidebar.gray','layouts.sidebar.image','layouts.sidebar.no-icons','layouts.sidebar.offcanvas',
'layouts.sidebar.on-hover','layouts.sidebar.on-hover-active','layouts.sidebar.with-lines','layouts.topbar.gradient','layouts.topbar.gray',
'layouts.topbar.light','pages.empty','shared.base','shared.horizontal','shared.partials.customizer',
'shared.partials.footer','shared.partials.footer-scripts','shared.partials.head-css','shared.partials.horizontal-nav','shared.partials.page-title',
'shared.partials.sidenav','shared.partials.title-meta','shared.partials.topbar','shared.vertical','testing_two.create',
'testing_two.edit','testing_two.index','testing_two.show','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state',
...
'C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with',
'C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.encoding','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum',
'C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array',
'C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file',
'C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in',
'C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4',
'C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array',
'C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file',
'C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file',
'C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes',
'C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits',
'C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all',
'C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters',
'C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present',
'C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited',
'C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits',
'C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted',
'C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without',
'C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric',
'C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique',
'C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid',
'C:.laragon.www.laravel-admin-page.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
